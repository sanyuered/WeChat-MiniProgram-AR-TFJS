(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var tfCore_esm = /*#__PURE__*/Object.freeze({
        ...
        Environment: o,
        KernelBackend: Zr,
        MomentumOptimizer: mp,
        Optimizer: cp,
        RMSPropOptimizer: gp,
        get Rank () { return ft; },
        get Reduction () { return bc; },
        SGDOptimizer: vp,
        Tensor: ht,
        TensorBuffer: st,
        Variable: pt,
   ...
   function getContext2dOrThrow(canvasArg) {
    var _a = env.getEnv(); 
    var ctx = _a.CanvasRenderingContext2D;
    return ctx;
   }
    ...
    function convLayer(x, params, padding, withRelu) {
        ...
        return Ue(function () {
            var out = mu(al(x, params.filters, [1, 1], padding), params.bias);
            return withRelu ? jl(out) : out;
        });
    }
    ...
    function extractConvParamsFactory(extractWeights, paramMappings) {
        return function (channelsIn, channelsOut, filterSize, mappedPrefix) {
            var filters = kn(extractWeights(channelsIn * channelsOut * filterSize * filterSize), [filterSize, filterSize, channelsIn, channelsOut]);
            var bias = En(extractWeights(channelsOut));
    ...
    function extractFCParamsFactory(extractWeights, paramMappings) {
        return function (channelsIn, channelsOut, mappedPrefix) {
            var fc_weights = Rn(extractWeights(channelsIn * channelsOut), [channelsIn, channelsOut]);
            var fc_bias = En(extractWeights(channelsOut));
    ...
    function extractSeparableConvParamsFactory(extractWeights, paramMappings) {
        return function (channelsIn, channelsOut, mappedPrefix) {
            var depthwise_filter = kn(extractWeights(3 * 3 * channelsIn), [3, 3, channelsIn, 1]);
            var pointwise_filter = kn(extractWeights(channelsIn * channelsOut), [1, 1, channelsIn, channelsOut]);
            var bias = En(extractWeights(channelsOut));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Qh.toPixels(imgTensor3D, targetCanvas)];
                    case 1:
                        _b.sent();
                        imgTensor3D.dispose();
    ...
    */
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        manifest = _b.sent();
                        return [2 /*return*/, Kh.loadWeights(manifest, modelBaseUri)];
                }
            });
        });
    }
    ...
    function padToSquare(imgTensor, isCenterImage) {
        ...
        return Ue(function () {
            ...
            var createPaddingTensor = function (paddingAmount) {
                ...
                return Dn(paddingTensorShape, 0);
            };
            ...
            return Bn(tensorsToStack, paddingAxis);
        });
    }
                ...
                var inputTensors = range(_this.batchSize, 0, 1).map(function (batchIdx) {
                    ...
                    if (input instanceof ht) {
                        ...
                        if (imgTensor.shape[1] !== inputSize || imgTensor.shape[2] !== inputSize) {
                            imgTensor = zc.resizeBilinear(imgTensor, [inputSize, inputSize]);
                        }
                        return imgTensor.as3D(inputSize, inputSize, 3);
                    }
                    if (input instanceof env.getEnv().Canvas) {
                        return Qh.fromPixels(imageToSquare(input, inputSize, isCenterInputs));
                    }
                    throw new Error("toBatchTensor - at batchIdx " + batchIdx + ", expected input to be instanceof tf.Tensor or instanceof HTMLCanvasElement, instead have " + input);
                });
                var batchTensor = Er(inputTensors.map(function (t) { return t.toFloat(); })).as4D(_this.batchSize, inputSize, inputSize, 3);
                return batchTensor;
            });
        };
        return NetInput;
    ...
    var NeuralNetwork = /** @class */ (function () {
        ...
        NeuralNetwork.prototype.freeze = function () {
            ...
            this.getTrainableParams().forEach(function (_a) {
                ...
                var tensor = bn(variable.dataSync());
                variable.dispose();
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            loadWeights = Kh.weightsLoaderFactory(fetchWeightsFromDisk);
                            _c = (_b = JSON).parse;
    ...
    function normalize(x, meanRgb) {
        return Ue(function () {
            ...
            var avg_r = Dn(x.shape.slice(0, 3).concat([1]), r);
            var avg_g = Dn(x.shape.slice(0, 3).concat([1]), g);
            var avg_b = Dn(x.shape.slice(0, 3).concat([1]), b);
            var avg_rgb = Bn([avg_r, avg_g, avg_b], 3);
            return Fu(x, avg_rgb);
        });
    }
    ...
    function leaky(x) {
        return Ue(function () {
            var min = Au(x, Cn(0.10000000149011612));
            return mu(jl(Fu(x, min)), min);
    ...
    function convWithBatchNorm(x, params) {
        return Ue(function () {
            var out = hr(x, [[0, 0], [1, 1], [1, 1], [0, 0]]);
            out = al(out, params.conv.filters, [1, 1], 'valid');
            out = Fu(out, params.bn.sub);
            out = Au(out, params.bn.truediv);
            out = mu(out, params.conv.bias);
            return leaky(out);
        });
    }
    ...
    function depthwiseSeparableConv(x, params) {
        return Ue(function () {
            var out = hr(x, [[0, 0], [1, 1], [1, 1], [0, 0]]);
            out = cl(out, params.depthwise_filter, params.pointwise_filter, [1, 1], 'valid');
            out = mu(out, params.bias);
            return leaky(out);
        });
    }
    ...
    function extractorsFactory(extractWeights, paramMappings) {
        ...
        function extractBatchNormParams(size, mappedPrefix) {
            var sub = En(extractWeights(size));
            var truediv = En(extractWeights(size));
        ...
        TinyYolov2.prototype.forwardInput = function (input, inputSize) {
            ...
            return Ue(function () {
                ...
                batchTensor = _this.config.meanRgb
                    ...
                    : batchTensor;
                batchTensor = batchTensor.div(Cn(256));
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            out = _b.sent();
                            out0 = Ue(function () { return kr(out)[0].expandDims(); });
                            inputDimensions = {
    ...
    function drawDetections(canvasArg, detections) {
        ...
        // 2019.8.22 added
        var ctx = getContext2dOrThrow(canvasArg);
        var environment = env.getEnv();
        ctx.draw(environment.isReserveDraw);   

    }

    function depthwiseSeparableConv$1(x, params, stride) {
        return Ue(function () {
            var out = cl(x, params.depthwise_filter, params.pointwise_filter, stride, 'same');
            out = mu(out, params.bias);
            return out;
        });
    }
    ...
    function denseBlock4(x, denseBlockParams, isFirstLayer, isScaleDown) {
        ...
        return Ue(function () {
            var out1 = jl(isFirstLayer
                ? mu(al(x, denseBlockParams.conv0.filters, isScaleDown ? [2, 2] : [1, 1], 'same'), denseBlockParams.conv0.bias)
                : depthwiseSeparableConv$1(x, denseBlockParams.conv0, isScaleDown ? [2, 2] : [1, 1]));
            var out2 = depthwiseSeparableConv$1(out1, denseBlockParams.conv1, [1, 1]);
            var in3 = jl(mu(out1, out2));
            var out3 = depthwiseSeparableConv$1(in3, denseBlockParams.conv2, [1, 1]);
            var in4 = jl(mu(out1, mu(out2, out3)));
            var out4 = depthwiseSeparableConv$1(in4, denseBlockParams.conv3, [1, 1]);
            return jl(mu(out1, mu(out2, mu(out3, out4))));
        });
    }
    ...
    var FaceFeatureExtractor = /** @class */ (function (_super) {
        ...
        FaceFeatureExtractor.prototype.forwardInput = function (input) {
            ...
            return Ue(function () {
                ...
                var normalized = normalize(batchTensor, meanRgb).div(Cn(255));
                var out = denseBlock4(normalized, params.dense0, true);
                out = denseBlock4(out, params.dense1);
                out = denseBlock4(out, params.dense2);
                out = denseBlock4(out, params.dense3);
                out = Rl(out, [7, 7], [2, 2], 'valid');
                return out;
            });
        };
    ...
    function fullyConnectedLayer(x, params) {
        return Ue(function () {
            return mu(fl(x, params.weights), params.bias);
        });
    }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            out = _a.sent();
                            return [4 /*yield*/, Promise.all(kr(out).map(function (t) { return __awaiter(_this, void 0, void 0, function () {
                                    var data;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
    ...
    function conv(x, params, stride) {
        return mu(al(x, params.filters, stride, 'same'), params.bias);
    }
    function reductionBlock(x, params, isActivateInput) {
        if (isActivateInput === void 0) { isActivateInput = true; }
        var out = isActivateInput ? jl(x) : x;
        out = depthwiseSeparableConv$1(out, params.separable_conv0, [1, 1]);
        out = depthwiseSeparableConv$1(jl(out), params.separable_conv1, [1, 1]);
        out = El(out, [3, 3], [2, 2], 'same');
        out = mu(out, conv(x, params.expansion_conv, [2, 2]));
        return out;
    }
    function mainBlock(x, params) {
        var out = depthwiseSeparableConv$1(jl(x), params.separable_conv0, [1, 1]);
        out = depthwiseSeparableConv$1(jl(out), params.separable_conv1, [1, 1]);
        out = depthwiseSeparableConv$1(jl(out), params.separable_conv2, [1, 1]);
        out = mu(out, x);
        return out;
    }
    var TinyXception = /** @class */ (function (_super) {
        ...
        TinyXception.prototype.forwardInput = function (input) {
            ...
            return Ue(function () {
                var batchTensor = input.toBatchTensor(112, true);
                var meanRgb = [122.782, 117.001, 104.298];
                var normalized = normalize(batchTensor, meanRgb).div(Cn(256));
                var out = jl(conv(normalized, params.entry_flow.conv_in, [2, 2]));
                ...
                out = jl(depthwiseSeparableConv$1(out, params.exit_flow.separable_conv, [1, 1]));
                return out;
            });
        };
        ...
        AgeGenderNet.prototype.runNet = function (input) {
            ...
            return Ue(function () {
                var bottleneckFeatures = input instanceof NetInput
                    ? _this.faceFeatureExtractor.forwardInput(input)
                    : input;
                var pooled = Rl(bottleneckFeatures, [7, 7], [2, 2], 'valid').as2D(bottleneckFeatures.shape[0], -1);
            ...
            return __generator(this, function (_a) {
                ...
                return [2, Ue(function () {      
                        ...
                        var faceTensors = boxes.map(function (_a) {
                            var x = _a.x, y = _a.y, width = _a.width, height = _a.height;
                            return Dl(imageTensor.as3D(imgHeight, imgWidth, numChannels), [y, x, 0], [height, width, numChannels]);
                        });
                        return faceTensors;
                    })];
        ...
        FaceLandmark68NetBase.prototype.postProcess = function (output, inputSize, originalDimensions) {
            ...
            return Ue(function () {
                ...
                var landmarkTensors = output
                    .mul(Dn([batchSize, 136], inputSize))
                    .sub(Er(Array.from(Array(batchSize), function (_, batchIdx) {
                    return createInterleavedTensor(getPaddingX(batchIdx), getPaddingY(batchIdx));
                })))
                    .div(Er(Array.from(Array(batchSize), function (_, batchIdx) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            netInput = _a.sent();
                            landmarkTensors = Ue(function () { return kr(_this.forwardInput(netInput)); });
    ...
    function extractorsFactory$4(extractWeights, paramMappings) {
        function extractFilterValues(numFilterValues, numFilters, filterSize) {
            ...
            return Ue(function () { return Yl(kn(weights, [numFilters, depth, filterSize, filterSize]), [2, 3, 1, 0]); });
        }
        function extractConvParams(numFilterValues, numFilters, filterSize, mappedPrefix) {
            var filters = extractFilterValues(numFilterValues, numFilters, filterSize);
            var bias = En(extractWeights(numFilters));
            paramMappings.push({ paramPath: mappedPrefix + "/filters" }, { paramPath: mappedPrefix + "/bias" });
            return { filters: filters, bias: bias };
        }
        function extractScaleLayerParams(numWeights, mappedPrefix) {
            var weights = En(extractWeights(numWeights));
            var biases = En(extractWeights(numWeights));
    ...
    function extractParams$5(weights) {
        ...
        var fc = Ue(function () { return Yl(Rn(extractWeights(256 * 128), [128, 256]), [1, 0]); });
    ...
    function residualDown(x, params) {
        ...
        out = convNoRelu(out, params.conv2);
        var pooled = Rl(x, 2, 2, 'valid');
        var zeros = Tn(pooled.shape);
        var isPad = pooled.shape[3] !== out.shape[3];
        var isAdjustShape = pooled.shape[1] !== out.shape[1] || pooled.shape[2] !== out.shape[2];
        if (isAdjustShape) {
            var padShapeX = out.shape.slice();
            padShapeX[1] = 1;
            var zerosW = Tn(padShapeX);
            out = Bn([out, zerosW], 1);
            var padShapeY = out.shape.slice();
            padShapeY[2] = 1;
            var zerosH = Tn(padShapeY);
            out = Bn([out, zerosH], 2);
        }
        pooled = isPad ? Bn([pooled, zeros], 3) : pooled;
        out = mu(pooled, out);
        out = jl(out);
        return out;
    }
    ...
    var FaceRecognitionNet = /** @class */ (function (_super) {
        ...
        FaceRecognitionNet.prototype.forwardInput = function (input) {
            ...
            return Ue(function () {
                ...
                var fullyConnected = fl(globalAvg, params.fc);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            netInput = _a.sent();
                            faceDescriptorTensors = Ue(function () { return kr(_this.forwardInput(netInput)); });
    ...
    function extractorsFactory$6(extractWeights, paramMappings) {
        function extractDepthwiseConvParams(numChannels, mappedPrefix) {
            var filters = kn(extractWeights(3 * 3 * numChannels), [3, 3, numChannels, 1]);
            var batch_norm_scale = En(extractWeights(numChannels));
            var batch_norm_offset = En(extractWeights(numChannels));
            var batch_norm_mean = En(extractWeights(numChannels));
            var batch_norm_variance = En(extractWeights(numChannels));
    ...
    function extractParams$6(weights) {
        ...
        var extra_dim = In(extractWeights(5118 * 4), [1, 5118, 4]);
        var output_layer = {
            extra_dim: extra_dim
        };
    ...
    function pointwiseConvLayer(x, params, strides) {
        return Ue(function () {
            var out = al(x, params.filters, strides, 'same');
            out = mu(out, params.batch_norm_offset);
            return Es(out, 0, 6);
        });
    }
    ...
    function depthwiseConvLayer(x, params, strides) {
        return Ue(function () {
            var out = ll(x, params.filters, strides, 'same');
            out = iu(out, params.batch_norm_mean, params.batch_norm_variance, params.batch_norm_offset, params.batch_norm_scale, epsilon);
            return Es(out, 0, 6);
        });
    }
    ...
    function getCenterCoordinatesAndSizesLayer(x) {
        ...
        var centers = [
            mu(vec[0], bu(sizes[0], Cn(2))),
            mu(vec[1], bu(sizes[1], Cn(2)))
        ];
        return {
            sizes: sizes,
            centers: centers
    ...
    function decodeBoxesLayer(x0, x1) {
        ...
        var vec = kr(Yl(x1, [1, 0]));
        var div0_out = bu(Au(Ss(bu(vec[2], Cn(5))), sizes[0]), Cn(2));
        var add0_out = mu(Au(bu(vec[0], Cn(10)), sizes[0]), centers[0]);
        var div1_out = bu(Au(Ss(bu(vec[3], Cn(5))), sizes[1]), Cn(2));
        var add1_out = mu(Au(bu(vec[1], Cn(10)), sizes[1]), centers[1]);
        return Yl(Er([
            Fu(add0_out, div0_out),
            Fu(add1_out, div1_out),
            mu(add0_out, div0_out),
            mu(add1_out, div1_out)
        ]), [1, 0]);
    }
    function outputLayer(boxPredictions, classPredictions, params) {
        return Ue(function () {
            var batchSize = boxPredictions.shape[0];
            var boxes = decodeBoxesLayer(br(Rr(params.extra_dim, [batchSize, 1, 1]), [-1, 4]), br(boxPredictions, [-1, 4]));
            boxes = br(boxes, [batchSize, (boxes.shape[0] / batchSize), 4]);
            var scoresAndClasses = Ps(Nl(classPredictions, [0, 0, 1], [-1, -1, -1]));
            var scores = Nl(scoresAndClasses, [0, 0, 0], [-1, -1, 1]);
            scores = br(scores, [batchSize, scores.shape[1]]);
            var boxesByBatch = kr(boxes);
            var scoresByBatch = kr(scores);
            return {
                boxes: boxesByBatch,
    ...
    function boxPredictionLayer(x, params) {
        return Ue(function () {
            ...
            var boxPredictionEncoding = br(convLayer(x, params.box_encoding_predictor), [batchSize, -1, 1, 4]);
            var classPrediction = br(convLayer(x, params.class_predictor), [batchSize, -1, 3]);
            return {
    ...
    var SsdMobilenetv1 = /** @class */ (function (_super) {
        ...
        SsdMobilenetv1.prototype.forwardInput = function (input) {
            ...
            return Ue(function () {
                ...
                var x = Fu(Au(batchTensor, Cn(0.007843137718737125)), Cn(1));
    ...
    function bgrToRgbTensor(tensor) {
        return Ue(function () { return Er(kr(tensor, 3).reverse(), 3); });
    }
    ...
    function extractorsFactory$8(extractWeights, paramMappings) {
        ...
        function extractPReluParams(size, paramPath) {
            var alpha = En(extractWeights(size));
    ...
    function normalize$1(x) {
        return Ue(function () { return Au(Fu(x, Cn(127.5)), Cn(0.0078125)); });
    }

    function prelu(x, alpha) {
        return Ue(function () {
            return mu(jl(x), Au(alpha, Os(jl(Os(x)))));
        });
    }
    ...
    function sharedLayer(x, params, isPnet) {
        ...
        return Ue(function () {
            ...
            out = El(out, isPnet ? [2, 2] : [3, 3], [2, 2], 'same');
            out = convLayer(out, params.conv2, 'valid');
            out = prelu(out, params.prelu2_alpha);
            out = isPnet ? out : El(out, [3, 3], [2, 2], 'valid');
    ...
    function PNet(x, params) {
        return Ue(function () {
            ...
            var max = sr(Wl(conv, 3), 3);
            var prob = Yr(Fu(conv, max), 3);
    ...
    function rescaleAndNormalize(x, scale) {
        return Ue(function () {
            ...
            var resized = zc.resizeBilinear(x, [height, width]);
            var normalized = normalize$1(resized);
            return Yl(normalized, [0, 2, 1, 3]);
        });
    }
    ...
    function stage1(imgTensor, scales, scoreThreshold, params, stats) {
        ...
        var pnetOutputs = scales.map(function (scale) { return Ue(function () {
            ...
            var scoresTensor = kr(kr(prob, 3)[1])[0];
            var regionsTensor = kr(regions)[0];
            return {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, imagePatchesDatas.map(function (data) {
                                var t = Ue(function () {
                                    var imagePatchTensor = Yl(kn(data, [1, width, height, 3]), [0, 2, 1, 3]).toFloat();
    ...
    function RNet(x, params) {
        return Ue(function () {
            ...
            var vectorized = br(convOut, [convOut.shape[0], params.fc1.weights.shape[0]]);
            ...
            var max = sr(Wl(fc2_1, 1), 1);
            var prob = Yr(Fu(fc2_1, max), 1);
            var regions = fullyConnectedLayer(prelu4, params.fc2_2);
            var scores = kr(prob, 1)[1];
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        scoresTensor = rnetOuts.length > 1
                            ? Bn(rnetOuts.map(function (out) { return out.scores; }))
                            : rnetOuts[0].scores;
                        _b = (_a = Array).from;
    ...
    function ONet(x, params) {
        return Ue(function () {
            ...
            var vectorized = br(out, [out.shape[0], params.fc1.weights.shape[0]]);
            var fc1 = fullyConnectedLayer(vectorized, params.fc1);
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        scoresTensor = onetOuts.length > 1
                            ? Bn(onetOuts.map(function (out) { return out.scores; }))
                            : onetOuts[0].scores;
                        _b = (_a = Array).from;
                        return [4 /*yield*/, scoresTensor.data()];
                    case 2:
                    ...
                    switch (_c.label) {
                        case 0:
                            ...
                            imgTensor = Ue(function () {
                                return bgrToRgbTensor(sr(Qh.fromPixels(inputCanvas)).toFloat());
                            });
